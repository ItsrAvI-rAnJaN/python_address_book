...
class Contact:
    ...
    def get_contact_dictionary(self):
        return {"id": self.id, "first_name": self.first_name, "last_name": self.last_name, "address": self.address, "city": self.city,
...
class AddressBook:
    ...
    def get_contacts_as_dictionary(self):
        ...
        for key, value in self.contact_dict.items():
            contact_details_dictionary.update(
                {value.first_name: value.get_contact_dictionary()})
    ...
    def display_contacts(self):
        ...
        try:
            if not self.contact_dict:
                ...
                print(
                    'id\tFirst Name\tLast Name\tAddress\tCity\tState\tCountry\tPIN\tPhone\tEmail')
                for key, value in self.contact_dict.items():
                    print("{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}".format(
                        value.id, value.first_name, value.last_name, value.address, value.city, value.state, value.country, value.pin, value.phone, value.email))
        except Exception as e:
            print(e)
            logging.exception(e)
...
class MultipleAddressBooks:
    ...
    def add_address_book(self, address_book_object):
        ...
        """
        self.address_book_dict.update(
            {address_book_object.address_book_name: address_book_object})
    ...
    def write_to_csv_file(self):
        ...
        try:
            with open("contact_info.csv", "w", newline="") as write_file:
                fieldnames = ['id', 'first_name', 'last_name', 'address',
...
def add_contact():
    ...
    try:
        ...
        address_book_object = multiple_address_book.get_address_book_object(
            address_book_name)
        ...
        contact_parameters = {"id": id, "first_name": first_name, "last_name": last_name, "address": address, "city": city,
